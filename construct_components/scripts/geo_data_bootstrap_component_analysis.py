...
os.chdir('/home/peer/code2/rpca_analysis_xizka/scripts/')
...
du = np.reshape(d, (1800, d.shape[1]*d.shape[2])).transpose()
...
filename = '/media/peer/fast_data/results_rpca/xizka/data_in/%s_var_b%d_cosweights_varimax%s.bin' % (DATA_NAME,NUM_BOOTSTRAPS,SUFFIX)
