...
class VARModel:
    ...
    def estimate(self, time_series, prng, fit_intercept = False, crit_type = 'sbc', ndx = None):
        ...
        # print n_p[p_max], q, 'look here!!!'
        # print n_p[p_max].dtype, q.dtype
        # print np.array(R).shape
        # print R[0][int(0):int(5),int(0):int(5)]
        # print np.array(R[0][0:5,0:5]).shape,'other shape?'
        # R = np.array(R)
        R22 = R[0][n_p[p_max]:q, n_p[p_max]:q] 
        ...
        for p in range(p_max, p_min-1, -1):
            ...
            if p < p_max:
                Rp = R[0][n_p[p]:q, n_p[p_max]:q_max]
        ...
        R11 = R[0][:n_p[p_opt], :n_p[p_opt]] 
        R12 = R[0][:n_p[p_opt], n_p[p_max]:n_p[p_max]+m]
        R22 = R[0][n_p[p_opt]:n_p[p_max]+m, n_p[p_max]:n_p[p_max]+m]    
