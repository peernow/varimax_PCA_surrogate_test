...
if __name__ == "__main__":
        ...
        os.chdir('/home/peer/code2/ndw-climate/src_xizka/')
        ...
        ### specifically it calculates first the anomalies relative to the seasonal cycle
        ...
        # dlam = pca_eigvals_gf(d)[:]
        # print dlam.shape,'dlam shape'
        # print dlam[0].shape
        # exit()
        ...
        plt.close(f)
        log('Arrived at the end of file')
        # end of processing
        log_file.close()
